...
// This program implements the (averaged) Message Passing algorithm on random Poisson networks.
...
int main(int argc, char **argv)
{
    ...
    sprintf(string2, "MessagePassing_Poi.txt");
    ...
    for(nc = 0; nc < 1; nc++) 
    {
        ...
        /* Message passing averaged on the ensemble */
